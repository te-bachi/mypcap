...
#define LOG_BIT8(var, mask, var_str)            uint8_t var_str[LOG_BIT8_LEN];      log_bit8 (var, mask, var_str)
#define LOG_BIT16(var, mask, var_str)           uint8_t var_str[LOG_BIT16_LEN];     log_bit16(var, mask, var_str)
#define LOG_BIT32(var, mask, var_str)           uint8_t var_str[LOG_BIT32_LEN];     log_bit32(var, mask, var_str)

#define LOG_TIME(var, var_str)                  uint8_t var_str[LOG_TIME_LEN];      log_time(var, var_str)
...
typedef enum {
    ...
    LOG_HEADER_DNS,
    LOG_HEADER_PTP2,
    LOG_HEADER_PTP2_SYNC,
    LOG_HEADER_PTP2_ANNOUNCE,
    LOG_HEADER_PTP2_DELAY_REQ,
    LOG_HEADER_PTP2_DELAY_RESP,
    LOG_HEADER_PTP2_SIGNALING,
...
void        log_bit8                    (const uint8_t      value,  const uint8_t   mask,   uint8_t *str);
