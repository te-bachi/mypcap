...
ptp2_delay_resp_header_new(void)
{
    ...
    LOG_PRINTLN(LOG_HEADER_PTP2_DELAY_RESP, LOG_DEBUG, ("PTP2 delay resp header new 0x%016" PRIxPTR, (unsigned long) header));
...
ptp2_delay_resp_header_free(header_t *header)
{
    ...
    LOG_PRINTLN(LOG_HEADER_PTP2_DELAY_RESP, LOG_DEBUG, ("PTP2 delay resp header free 0x%016" PRIxPTR, (unsigned long) header));
