...
ptp2_sync_header_new(void)
{
    ...
    LOG_PRINTLN(LOG_HEADER_PTP2_SYNC, LOG_DEBUG, ("PTP2 sync header new 0x%016" PRIxPTR, (uintptr_t) header));
...
ptp2_sync_header_free(header_t *header)
{
    ...
    LOG_PRINTLN(LOG_HEADER_PTP2_SYNC, LOG_DEBUG, ("PTP2 sync header free 0x%016" PRIxPTR, (uintptr_t) header));
