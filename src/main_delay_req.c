...
packet_t               *create_ptp2_delay_req(mac_address_t *slave_mac, ipv4_address_t *slave_ipv4);
...
packet_t *
create_ptp2_delay_req(mac_address_t *slave_mac, ipv4_address_t *slave_ipv4)
{
...
main(int argc, char *argv[])
{
    ...
    packet = create_ptp2_delay_req(&slave_mac, &slave_ipv4);
